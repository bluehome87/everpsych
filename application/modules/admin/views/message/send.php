							...
							<?php if(isset($messages)):?>		
							 <?php $i=1;foreach ($messages as $new){?>		
									...
									<?php 
										if(empty($new->image)){
									?>
                                        <img src="<?php echo site_url('assets/uploads/images/avatar5.png')?>" alt="user image" class="online"/>
									<?php }else{ ?>
									 <img src="<?php echo site_url('assets/uploads/images/'.$new->image)?>" alt="user image" class="online"/>
									<?php }?>	
